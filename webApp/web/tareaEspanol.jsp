...
<head>
    ...
    <script>
        function verificar() {
            ...
            if (respuesta === "sustantivo") {
                resultado.style.color = "green";
                resultado.innerHTML = "✅ ¡Correcto! Muy bien.";
            } else {
                resultado.style.color = "red";
                resultado.innerHTML = "❌ Incorrecto. Recuerda: 'perro' es un sustantivo.";
            }
        }
    </script>
</head>
...
<div class="card">
    ...
    <h1>Tarea de Español</h1>
    <p class="subtitulo">Responde la siguiente pregunta</p>

    <div class="pregunta">
        ¿Qué tipo de palabra es <strong>“perro”</strong>?
        <br><span style="font-size:14px; color:#666;">(Ejemplo: verbo, adjetivo, sustantivo...)</span>
    </div>
