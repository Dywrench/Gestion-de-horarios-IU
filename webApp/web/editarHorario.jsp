...
td { padding:10px; }
input[type="text"], input[type="time"] { width:100%; padding:8px; border:1px solid #ccc; border-radius:8px; }
...
input[type="submit"] { background:#f59e0b; } input[type="button"] { background:#6b7280; }
input[type="submit"]:hover { background:#b45309; } input[type="button"]:hover { background:#4b5563; }
...
<form method="post" action="HorarioServlet">
    ...
    <table>
        <tr><td>Día:</td><td><input type="text" name="dia" value="<%=h.getDia()%>" required/></td></tr>
        <tr><td>Hora Inicio:</td><td><input type="time" name="horaInicio" value="<%=h.getHoraInicio()%>" required/></td></tr>
        <tr><td>Hora Fin:</td><td><input type="time" name="horaFin" value="<%=h.getHoraFin()%>" required/></td></tr>
        <tr><td>Materia:</td><td><input type="text" name="materia" value="<%=h.getMateria()%>" required/></td></tr>
